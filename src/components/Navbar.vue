...
<template>
    <nav class="">
        ...
        <div id="navbar" class="bg-neutral-800 m-2 rounded-2xl p-5 flex justify-between">
            ...
            <button v-if="windowWidth < 900" @click="toggleNav" class="cursor-pointer text-5xl relative bottom-1.5">☰</button>
            <ul class="flex gap-3" v-else >
                <li v-for="link in links" class="hover:bg-neutral-600 px-2 py-3 rounded-xl w-[100%] flex items-center text-[14px]">
        ...
        <ul v-if="isNavOpen" id="navbar-list"
            class="bg-neutral-800 m-2 rounded-2xl p-5 flex flex-col items-center text-sm">
